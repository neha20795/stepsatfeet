 ...
 call(option: number){
  this.option = option;
    switch(this.option){
      ...
      case 3 : this.url = "reviewbyyou"; this.showselectedData="Reviews Given By You";
               this.msg="Click below button if you want to view reviews given by you"; break;
      case 4 : this.url = "reviewforyou"; this.showselectedData="Review Received By You";
               this.msg="Click below button if you want to view reviews you received"; break;
      case 5 : this.url = "confidentialinforequest"; this.showselectedData="Confidential Information";
               this.msg="Click below button to check about Confidential Aggrement Request"; break;
      case 6 : this.url = "review"; this.showselectedData="Review";
